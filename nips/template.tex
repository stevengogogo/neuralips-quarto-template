...
\maketitle
\begin{abstract}
This document is a template demonstrating the Nips format.
\end{abstract}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, borderline west={3pt}{0pt}{shadecolor}, frame hidden, sharp corners, enhanced, interior hidden, boxrule=0pt]}{\end{tcolorbox}}\fi
